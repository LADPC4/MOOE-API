...
// $sysrolewf->set_property("schdivid",$data->schdivid) ;
// $sysrolewf->set_property("confirmed","N") ;
...
// query products
$stmt = $sysrolewf->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$sysrolewf->count();
    $page_url="{$home_url}sysrolewf/read_paging.php?";
