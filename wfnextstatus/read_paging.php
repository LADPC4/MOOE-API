...
// $wfnextstatus->set_property("schdivid",$data->schdivid) ;
// $wfnextstatus->set_property("confirmed","N") ;
...
// query products
$stmt = $wfnextstatus->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$wfnextstatus->count();
    $page_url="{$home_url}wfnextstatus/read_paging.php?";
