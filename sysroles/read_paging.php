...
// $sysroles->set_property("schdivid",$data->schdivid) ;
// $sysroles->set_property("confirmed","N") ;
...
// query products
$stmt = $sysroles->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $page_url="{$home_url}sysroles/read_paging.php?";
