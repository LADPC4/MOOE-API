...
$mooerequests->set_property("es",$data->es) ;
$mooerequests->set_property("jhs",$data->jhs) ;
$mooerequests->set_property("shs",$data->shs) ;
...
// query products
$stmt = $mooerequests->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
