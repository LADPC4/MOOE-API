...
include_once '../objects/flowtypes.php';
...
// $flowtypes->set_property("schdivid",$data->schdivid) ;
// $flowtypes->set_property("confirmed","N") ;
...
// query products
$stmt = $flowtypes->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$flowtypes->count();
    $page_url="{$home_url}flowtypes/read_paging.php?";
