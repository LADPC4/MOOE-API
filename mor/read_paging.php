...
include_once '../objects/ct_mor.php';
...
// echo ("Nelson ");
// $ctmor->set_guserid($data->gsysuserid) ;
...
// query products
$stmt = $ctmor->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$ctmor->count();
    $page_url="{$home_url}ctmor/read_paging.php?";
