...
// $sysrolehierarchy->set_property("schdivid",$data->schdivid) ;
// $sysrolehierarchy->set_property("confirmed","N") ;
...
// query products
$stmt = $sysrolehierarchy->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$sysrolehierarchy->count();
    $page_url="{$home_url}sysrolehierarchy/read_paging.php?";
