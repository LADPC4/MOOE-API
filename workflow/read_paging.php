...
// $workflow->set_property("schdivid",$data->schdivid) ;
// $workflow->set_property("confirmed","N") ;
...
// query products
$stmt = $workflow->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$workflow->count();
    $page_url="{$home_url}workflow/read_paging.php?";
