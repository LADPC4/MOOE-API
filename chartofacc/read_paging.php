...
// initialize object
$chartofacc = new chartofacc($db);

// get posted data
$data = json_decode(file_get_contents("php://input"));
// echo ("Nelson ");
// $chartofacc->set_guserid($data->gsysuserid) ;
...
// query products
$stmt = $chartofacc->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$chartofacc->count();
    $page_url="{$home_url}chartofacc/read_paging.php?";
