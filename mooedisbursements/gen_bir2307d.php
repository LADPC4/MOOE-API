...
$mooedisbursements->set_property("schdivid",$data->schdivid) ;
...
// query transactions 
$stmt = $mooedisbursements->genBIR2307d($from_record_num, $records_per_page);
// print_r($stmt);
$num = $stmt->rowCount();
// echo $num; 
