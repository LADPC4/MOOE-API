...
$mooedisbursements->set_property("roleguid",$data->roleguid) ;
...
// query products
$stmt = $mooedisbursements->readPending($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$mooedisbursements->Pendingcount();
