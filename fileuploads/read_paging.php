...
$fileuploads->set_property("recowner",$data->recowner) ;
// $fileuploads->set_property("confirmed","N") ;
...
// query products
$stmt = $fileuploads->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$fileuploads->count();
    $page_url="{$home_url}fileuploads/read_paging.php?";
