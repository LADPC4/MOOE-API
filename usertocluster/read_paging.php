...
// $sysusrschcluster->set_property("confirmed","N") ;
...
// query products
$stmt = $sysusrschcluster->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$sysusrschcluster->count();
    $page_url="{$home_url}sysusrschcluster/read_paging.php?";
