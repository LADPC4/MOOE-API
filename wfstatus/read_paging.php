...
// $wfstatus->set_property("schdivid",$data->schdivid) ;
// $wfstatus->set_property("confirmed","N") ;
...
// query products
$stmt = $wfstatus->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$wfstatus->count();
    $page_url="{$home_url}wfstatus/read_paging.php?";
