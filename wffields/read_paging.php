...
// $wffields->set_property("schdivid",$data->schdivid) ;
// $wffields->set_property("confirmed","N") ;
...
// query products
$stmt = $wffields->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$wffields->count();
    $page_url="{$home_url}wffields/read_paging.php?";
