...
if (isset($data->cofund)){
    // $funds->set_property("cofund",  ) ;
}
...
// query products
$stmt = $funds->readOthersPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$funds->otherscount();
    $page_url="{$home_url}funds/read_otherspaging.php?";
