...
// query products
$stmt = $vatmatrix->GetTranTypes($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$vatmatrix->TranTypecount();
    $page_url="{$home_url}vatmatrix/read_unconfirmedvatmatrix.php?";
