...
// print_r($sysrolemenus);
$sysrolemenus->set_property("gsysrole",$data->gsysrole) ;
// $sysrolemenus->set_property("confirmed","N") ;
...
// query products
$stmt = $sysrolemenus->readrolemenus($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$sysrolemenus->readrolemenuscount();
    $page_url="{$home_url}sysrolemenus/read_paging.php?";
