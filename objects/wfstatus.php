...
class wfstatus {
	...
	private $conn;
	//declare table name
   	private $table_name = "ct_wfstatus";
	//auto generated
    public $lasterror=null;
	public  $PRIMARY_KEY = array('id'=>'id');
	private $FIELD_NAME = array('id'=>'id',  'name'=>'name', 'gorder'=>'gorder', 'gshow'=>'gshow',    'rectimestamp'=>'rectimestamp');
	protected $FIELD_MODIFIED = array();
	protected $RESULT = array();
	protected static $FOREIGN_KEYS = array();

    //wfstatus, wfstatus, divguid, schoolguid, paps, totalamount, transferdate, fundyear, mooerequest, rectimestamp

	// protected $wfstatus = null;
	// protected $name = null;
	...
	// public function set_wfstatus($pArg='0') {
	// 	IF ( $this->wfstatus !== $pArg){
	// 		$this->wfstatus=$pArg; $this->FIELD_MODIFIED['wfstatus']=1;
	// 	}
	// }
	// public function set_name($pArg='0') {
	// 	IF ( $this->name !== $pArg){
	// 		$this->name=$pArg; $this->FIELD_MODIFIED['name']=1;
	// 	}
	// }
	...
	// public function get_wfstatus() { return (string) $this->wfstatus; }
...
function delete(){
    ...
    $stmt->bindParam(":wfstatus", $this->wfstatus);
