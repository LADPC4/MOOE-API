...
class chartofacc {
	...
	private $conn;
	//declare table name
   	private $table_name = "ct_chartofacc";
	//auto generated
    public $lasterror=null;
	public  $PRIMARY_KEY = array('coaguid'=>'coaguid');
	private $FIELD_NAME = array('coaguid'=>'coaguid',  'coacode'=>'coacode', 'coadesc'=>'coadesc',  'rectimestamp'=>'rectimestamp');
	protected $FIELD_MODIFIED = array();
	protected $RESULT = array();
	protected static $FOREIGN_KEYS = array();

    //coaguid, coaguid, divguid, schoolguid, paps, totalamount, transferdate, fundyear, mooerequest, rectimestamp

	// protected $coaguid = null;
	// protected $coacode = null;
	...
	// public function set_coaguid($pArg='0') {
	// 	IF ( $this->coaguid !== $pArg){
	// 		$this->coaguid=$pArg; $this->FIELD_MODIFIED['coaguid']=1;
	// 	}
	// }
	// public function set_coacode($pArg='0') {
	// 	IF ( $this->coacode !== $pArg){
	// 		$this->coacode=$pArg; $this->FIELD_MODIFIED['coacode']=1;
	// 	}
	// }
	...
	// public function get_coaguid() { return (string) $this->coaguid; }
	// public function get_coacode() { return (string) $this->coacode; }
...
function delete(){
    ...
    $stmt->bindParam(":coaguid", $this->coaguid);
...
function readOne(){
   ...
   public function readPaging($from_record_num, $records_per_page){
            ...
            $query = "SELECT " 
                       ...
                       , concat(coacode,' - ', coadesc) codedesc
                FROM
...
function getbycode(){
    ...
    $this->coaguid= $row['coaguid'];
    $this->schoolguid= $row['schoolguid'];
    $this->coacode= $row['coacode'];
