...
class sysrolewf {
	...
	//declare table roleguid
   	private $table_sysrolewf = "sysrolewf";
	//auto generated
    public $lasterror=null;
	public  $PRIMARY_KEY = array('rwfguid'=>'rwfguid');
	private $FIELD_roleguid = array('rwfguid'=>'rwfguid',  'roleguid'=>'roleguid', 'wfguid'=>'wfguid', 'rectimestamp'=>'rectimestamp');
	protected $FIELD_MODIFIED = array();
	protected $RESULT = array();
	protected static $FOREIGN_KEYS = array();

    //rwfguid, roleguid, wfguid, rectimestamp

	// protected $sysrolewf = null;
	...
	// public function set_sysrolewf($pArg='0') {
	// 	IF ( $this->sysrolewf !== $pArg){
	// 		$this->sysrolewf=$pArg; $this->FIELD_MODIFIED['sysrolewf']=1;
	// 	}
	// }
	...
	// public function get_sysrolewf() { return (string) $this->sysrolewf; }
...
function create(){
    ...
    $query = "INSERT INTO " . $this->table_sysrolewf . " SET ".$this->createUpdFlds();
...
function update(){
   ...
   $query = "Update " . $this->table_sysrolewf . " SET ".$this->createUpdFlds()."  where ".$this->createIDQry();
...
function readOne(){
   ...
   public function readPaging($from_record_num, $records_per_page){
            ...
            $query = "select distinct a.roleguid, b.roledescription
                  ...
                  ct_workflow c on a.wfguid=c.wfguid
    ...
    public function readrolewflist(){
...
public function readrolewflistcount(){
    $query = "SELECT COUNT(*) as total_rows FROM " . $this->table_sysrolewf . " where 
    roleguid=:roleguid";
...
public function count(){
    $query = "SELECT COUNT(*) as total_rows FROM " . $this->table_sysrolewf . "";
