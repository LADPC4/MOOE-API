...
class ctmor {
	...
	private $conn;
	//declare table name
   	private $table_name = "ct_mor";
	//auto generated
    public $lasterror=null;
	public  $PRIMARY_KEY = array('morguid'=>'morguid');
	private $FIELD_NAME = array('morguid'=>'morguid',  'mordesc'=>'mordesc',  'rectimestamp'=>'rectimestamp');
	protected $FIELD_MODIFIED = array();
	protected $RESULT = array();
	protected static $FOREIGN_KEYS = array();

    //morguid, morguid, divguid, schoolguid, paps, totalamount, transferdate, fundyear, mooerequest, rectimestamp

	// protected $morguid = null;
	...
	// public function set_morguid($pArg='0') {
	// 	IF ( $this->morguid !== $pArg){
	// 		$this->morguid=$pArg; $this->FIELD_MODIFIED['morguid']=1;
	// 	}
	// }
	...
	// public function get_morguid() { return (string) $this->morguid; }
...
function delete(){
    ...
    $stmt->bindParam(":morguid", $this->morguid);
