...
class wffields {
	...
	private $conn;
	//declare table name
   	private $table_name = "ct_wffields";
	//auto generated
    public $lasterror=null;
	public  $PRIMARY_KEY = array('wffguid'=>'wffguid');
	private $FIELD_NAME = array('wffguid'=>'wffguid',  'wfguid'=>'wfguid', 'wffield'=>'wffield', 'wffielddesc'=>'wffielddesc', 'rectimestamp'=>'rectimestamp');
	protected $FIELD_MODIFIED = array();
	protected $RESULT = array();
	protected static $FOREIGN_KEYS = array();

    //wffguid, wffguid, wffield, rectimestamp

	// protected $wffguid = null;
	// protected $type = null;
	...
	// public function set_wffguid($pArg='0') {
	// 	IF ( $this->wffguid !== $pArg){
	// 		$this->wffguid=$pArg; $this->FIELD_MODIFIED['wffguid']=1;
	// 	}
	// }
	...
	// public function get_wffguid() { return (string) $this->wffguid; }
...
function delete(){
    ...
    $stmt->bindParam(":wffguid", $this->wffguid);
...
function readOne(){
    ...
    $query = "SELECT
            ...
            FROM
                ...
                ct_workflow b on a.wfguid=b.wfguid
    ...
    function readAllocatedTransferred(){
        ...
        $query = "select gaayear,c.type,
                    ...
                    from gaallocation a inner join 
                        ...
                        wffields d on b.status = d.status and d.fundyear = a.gaayear left join 
                        mooedisbursements e on d.wffguid = e.wffguid
...
function readFundBalance(){
    ...
    $query = "select a.description , 
                ...
                from wffields a inner join 
                    mooedisbursements b on a.wffguid = b.wffguid
                 ".$this->createWhereQry($tblprfx)."
                

            ";

    // prepare query statement b.status = :status and a.wffguid= wffguid
   ...
   public function readPaging($from_record_num, $records_per_page){
    ...
    public function readFields($from_record_num, $records_per_page){
